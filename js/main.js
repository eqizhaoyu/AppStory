...
/*字符拼接区*/
    ...
    var str = introduce.concat(sty1).concat(trs1).concat(lightheight).concat(trs2).concat(drawBoard).concat(resume).concat(trs3);
	 ...
	 function put(){
		...
		if(n>=672&&n<=900){
			...
			var drawBoard = document.getElementById('drawBoard');
				drawBoard.innerHTML =str.substring(900,n);
	    ...
	    if(n>=2000){
	     	  ...
	     	  sourceBoard.innerHTML =  Prism.highlight(str.substring(0,900), Prism.languages.css)+Prism.highlight(str.substring(2000,n), Prism.languages.css);
	     ...
	     if(n>=2236){
	     	var drawBoard = 	document.getElementById('drawBoard');
	     	drawBoard.innerHTML =marked(str.substring(900,2000));
