	 ...
	 function put(){
		...
		if(n>=672&&n<=1286){
			...
			var drawBoard = document.getElementById('drawBoard');
				drawBoard.innerHTML =str.substring(1286,n);
	    ...
	    if(n>=2240){
	     	  ...
	     	  sourceBoard.innerHTML =  Prism.highlight(str.substring(0,1286), Prism.languages.css)+Prism.highlight(str.substring(2240,n), Prism.languages.css);
	     ...
	     if(n>=2330){
	     	var drawBoard = 	document.getElementById('drawBoard');
	     	drawBoard.innerHTML =marked(str.substring(1286,2240));
