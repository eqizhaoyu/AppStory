	 ...
	 function put(){
		...
		if(n>=672&&n<=920){
			...
			var drawBoard = document.getElementById('drawBoard');
				drawBoard.innerHTML =str.substring(920,n);
	    ...
	    if(n>=2000){
	     	  ...
	     	  sourceBoard.innerHTML =  Prism.highlight(str.substring(0,920), Prism.languages.css)+Prism.highlight(str.substring(2000,n), Prism.languages.css);
	     ...
	     if(n>=2236){
	     	var drawBoard = 	document.getElementById('drawBoard');
	     	drawBoard.innerHTML =marked(str.substring(920,2000));
