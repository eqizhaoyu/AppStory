	 ...
	 function put(){
		...
		if(n>=672&&n<=1288){
			...
			var drawBoard = document.getElementById('drawBoard');
				drawBoard.innerHTML =str.substring(1288,n);
	    ...
	    if(n>=2242){
	     	  ...
	     	  sourceBoard.innerHTML =  Prism.highlight(str.substring(0,1288), Prism.languages.css)+Prism.highlight(str.substring(2242,n), Prism.languages.css);
	     ...
	     if(n>=2330){
	     	var drawBoard = 	document.getElementById('drawBoard');
	     	drawBoard.innerHTML =marked(str.substring(1288,2242));
