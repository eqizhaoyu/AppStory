...
/*源码版控制区*/	 
var controller= setInterval(put,80);
	 function put(){
		...
		if(n>=672&&n<=1284){
			...
			var drawBoard = document.getElementById('drawBoard');
				drawBoard.innerHTML =str.substring(1284,n);
		...
		/*故事板写完之后，需要在sourceBoard中写入魔术代码*/	
	    if(n>=2238){
	     
	     	  sourceBoard.innerHTML =  Prism.highlight(str.substring(0,1284), Prism.languages.css)+Prism.highlight(str.substring(2238,n), Prism.languages.css);
	     ...
	     if(n>=2332){
	     	var drawBoard = 	document.getElementById('drawBoard');
	     	drawBoard.innerHTML =marked(str.substring(1284,2238));
